 ...
 * @version 2018/11/13
 * - made it prompt to load memory even if none exists, to match expected output logs
 * @version 2018/11/10
...
QuestionGUI::~QuestionGUI() {
    // note: QuestionTree destructor will be called here
...
void QuestionGUI::handleYesClick() {
    ...
    if (prompt == QuestionConstants::LOAD_MEMORY_MESSAGE) {
        // load from file
        readData(QuestionConstants::MEMORY_FILE);
